  ...
  theme: {
    extend: {
      colors: {
        ...
        // Google OAuth colors for SVG icons
        google: {
        ...
        // Product/clothing colors for ColorPicker component
        product: {
          black: 'var(--color-product-black)',
          white: 'var(--color-product-white)',
          gray: 'var(--color-product-gray)',
          navy: 'var(--color-product-navy)',
          blue: 'var(--color-product-blue)',
          red: 'var(--color-product-red)',
          pink: 'var(--color-product-pink)',
          green: 'var(--color-product-green)',
          yellow: 'var(--color-product-yellow)',
          orange: 'var(--color-product-orange)',
          purple: 'var(--color-product-purple)',
          brown: 'var(--color-product-brown)',
          beige: 'var(--color-product-beige)',
        },
        gray: {
          0: 'var(--color-gray-0)',
