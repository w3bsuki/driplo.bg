...
// Completely isolated schema for selling page - no external imports
export const sellPageSchema = z.object({
	// Basic Info
	title: z.string()
...
export type SellPageFormData = z.infer<typeof sellPageSchema>

// Form defaults without any external dependencies
export const sellPageDefaults: Partial<SellPageFormData> = {
	title: '',
	description: '',
	category_id: '',
	subcategory_id: null,
