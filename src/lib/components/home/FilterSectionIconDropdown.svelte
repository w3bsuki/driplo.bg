<script lang="ts">
	...
	import CategoryDropdownIconOnly from './CategoryDropdownIconOnly.svelte';
...
<section class="py-4 border-b bg-background">
	<div class="container px-4">
		<!-- Search Bar with Icon-Only Categories Dropdown -->
		<div class="max-w-4xl mx-auto mb-4">
			<div class="flex gap-3">
				<!-- Icon-Only Categories Dropdown -->
				<div class="flex-shrink-0">
					<CategoryDropdownIconOnly />
				</div>
