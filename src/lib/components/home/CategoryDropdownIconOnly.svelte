...
<div class="relative">
	...
	{#if isOpen}
		<div class="hidden md:block absolute top-full left-0 mt-2 w-80 bg-background border border-border rounded-xl shadow-xl z-50 max-h-[70vh] overflow-y-auto">
			<div class="p-4">
